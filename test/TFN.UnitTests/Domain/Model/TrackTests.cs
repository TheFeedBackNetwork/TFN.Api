...
namespace TFN.UnitTests.Domain.Model
{
    public class TrackTests
    {
        ...
        {
            return make_Track(TrackIdDefault,UserIdDefault,LocationDefault,waveForm,TrackMetaDataDefault,CreatedDefault);
        }

        public Track make_Track(TrackMetaData metaData)
        {
            return make_Track(TrackIdDefault,UserIdDefault,LocationDefault,SoundWaveDefault,metaData,CreatedDefault);
        }
